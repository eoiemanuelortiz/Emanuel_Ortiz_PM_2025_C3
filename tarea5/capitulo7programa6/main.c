...
strcpy(cad1, "XX");
printf("\nPrueba de l funcion strcpy. Se copia la cadena XX a cad1: %s\n", cad1);
...
printf("\nPrueba de la funcion strncpy. se copian 3 caracteres de cad3 a cad2: %s\n",
       cad2);
strcat(cad0, cad3);
printf("\nPrueb de la funcion strcat. se incorpora la cadena cad3 a cad0: %s\n", cad0);

strcat(cad1, " YY");
printf("\nPrueba de la afuncion strcat. Se incorpora la caaden YY  a cad1: %s\n", cad1);
...
printf("\nPruba de la funcion strstr. Se trata de localizar la cadena Guatemala dentro de cad0: %s\n", cad0);
}
